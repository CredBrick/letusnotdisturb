  ...
  return (
    ...
    <div className='min-w-[20%] h-[520px] md:min-w-[50%] md:h-[640px] m-auto relative group'>
        <div
            ...
            {/* text */}
            <p className='absolute mt-4 text-xl md:top-[200px] top-[170px] font-semibold'>
    ...
    <div className="relative">
      ...
      />
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4 bg-black bg-opacity-50 text-white">
        <p className="absolute md:top-[70px] top-[50px] font-semibold md:text-4xl text-xl">Things We Do</p>
        <p className='absolute whitespace-pre-wrap mt-4 px-6 md:text-lg text-md md:top-[150px] top-[100px] font-semibold'>Facilitating Ideation & Brainstorming Sessions | Private Virtual Concerts | Art Workshops
        <br/>
        ...
        <button className='absolute mt-4 text-xl md:top-[300px] top-[300px] hover:bg-white/90 text-black bg-white hover:opacity-60 py-5 px-2 font-semibold '>
    ...
    {/* text section */}
    <div className="text-white text-center mt-10 font-semibold">
      <p 
        className='text-xl whitespace-pre-wrap px-6'>
          10+ Years Giving Toward The Community
      </p>
      <p 
        className='whitespace-pre-wrap mt-6 md:px-[130px] px-[50px] mb-[70px]'>
    ...
    <div className='relative'>
      <img
        ...
        <p className="absolute md:top-[70px] top-[50px] md:text-4xl text-2xl">Made For</p>
        <p className='absolute whitespace-pre-wrap mt-4 px-6 md:text-lg text-md md:top-[150px] top-[100px] font-semibold'>
          Creators
          <br/>
          Game Changers
          <br/>
        ...
        <p className='absolute mt-4 px-6 md:text-4xl text-2xl md:top-[350px] top-[300px]'>You</p>
      </div>
    </div>
    ...
    <div className="mt-[70px] ">
        <div className="items-center ">
          <p className="mt-7 text-center text-white text-4xl">What People Are Saying About Us</p>
        </div>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-5 my-6 px-5 md:px-0'>
          <div className="flex flex-col md:p-8">
            <p className="mt-7 text-white text-lg text-center whitespace-pre-wrap">“The Lehza.in event was huge and success. I learnt a lot from the host and its a great platform to get inspired and happy living. I will definitely recommend this virtual concert to everyone”</p>
            <p className="mt-2 text-center text-white text-lg">— Siddharth Shukla</p>
          </div>
          <div className="flex flex-col items-center md:p-8">
            <p className="mt-7 text-center text-white text-lg">“I was blown away how well LetUsNotDisturb team. All is not lost because of COVID Pandemic. I was fortunate enough to experience the best virtual concert I have ever attended.”</p>
            <p className="mt-2 text-center text-white text-lg">—  Diksha Das</p>
          </div>
        </div>
    </div>
