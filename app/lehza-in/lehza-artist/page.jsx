    ...
    <div className="text-white font-light">
      ...
      <div className="">
        <p className="text-center text-2xl md:text-4xl lg:text-5xl mt-10">
          What we offer at
          <a
            href="https://www.instagram.com/lehza.in/"
            target="_blank"
        ...
        <div className="flex flex-col md:flex-row mt-10">
          <div className="flex flex-col items-center justify-center text-center basis-1/3">
            ...
            <p className="px-6 text-lg mb-8">
              Lehza.in artist webinar series brings together artists, industry
              experts and professionals to share what they've learned.
            </p>
          </div>
          <div className="flex flex-col items-center justify-center text-center basis-1/3">
      ...
      <div className="flex flex-col md:flex-row mt-10">
        ...
        <div className="flex flex-col items-center justify-center basis-1/2 font-light">
          <h1 className="text-xl md:text-3xl lg:text-5xl mb-8">
            Host & Voice -
          </h1>
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 md:gap-5 gap-10 my-14 px-5 md:px-0">
        ...
        <div className="flex flex-col items-center">
          <GiArchiveRegister className="text-white font-normal" size={70} />
          <p className="mt-7 text-center text-white text-4xl">100+</p>
          <p className="mt-2 text-center text-white text-4xl">
            Registered Artist
          </p>
        </div>
        <div className="flex flex-col items-center">
          <IoIosPeople className="text-white font-normal" size={70} />
      ...
      <div className="mt-6 md:mt-10 lg:mt-[100px] font-light text-center">
        <h1 className="text-4xl mb-8">Bringing Lehza.in To You</h1>
        <p className="text-lg px-4 md:px-[120px] lg:px-[250px]">
          As we work toward bringing in-person shows safely back to your local
          community, we're more committed than ever to the idea that live
          session brings people together. Join independent artists around the
          world for intimate livestream performances in the Lehza.in streaming
          room!
        </p>
      </div>
      ...
      <div className="relative mt-10">
        ...
        <div className="absolute inset-0 flex flex-col text-center">
          ...
          <p className="text-lg px-10 mt-10">
            Register in one of our courses to become a part of a vibrant
            community of artists - writers, poets, musicians, painters,
              ...
              >
                <div className="">
                  <input
                    ...
                    id="name"
                    className="appearance-none border rounded w-full py-4 px-[60px] text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
